...
class RedesNeuronales(ABC):
    ...
    def definir_set_entrenamiento(self) -> None:
        print('-I- 32,000 imágenes encontradas, definiendo 80% para entrenamiento y 20% para prueba')
    ...
    # Métodos opcionales para implementar en las subclases
...
class DeteccionObjetos(RedesNeuronales):
    def limpieza_de_datos(self) -> None:
        print('-I- Ajustando tamaño y bandas de la imagen')
